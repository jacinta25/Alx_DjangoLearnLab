...
SECRET_KEY = 'django-insecure-8^(c0c&5m8f=wo()-7i(1g_fe=&2lnei*_4l(_t5rt6&0x8*iu'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Defines the directory for collectstatic
