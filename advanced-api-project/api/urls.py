...
urlpatterns = [
    ...
    path('books/update/', BookUpdateView.as_view(), name='book-update'), # Update a book by ID
    path('books/delete/', BookDeleteView.as_view(), name='book-delete'), # Delete a book by ID
]
